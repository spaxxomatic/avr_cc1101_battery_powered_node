...
class CC1101
{
  ...
  public:
     ...
     * Initializa CC1101
     */
    void init(uint8_t freq=CFREQ_433, uint8_t mode=0);
    ...
    /** nutiu - adjust freq calibration (offset)
    * freq1 - offset value for register FREQ1
    * freq0 - offset value for register FREQ1
    */
    void adjustFreq(byte freq1, byte freq0, bool save) ;
