...
//nutiu - enable this for cul compat #define GDO0	 0        // PB0 - arduino 8
...
#define BIT_GDO0  2
//nutiu - enable this for cul compat #define PORT_GDO0  PINB
//nutiu - enable this for cul compat #define BIT_GDO0  0
